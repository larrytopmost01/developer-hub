...
Route::post('/book_develop', [UserController::class, 'book_dev']);
Route::get('/bookingdeve', [UserController::class, 'deve_forum']);
Route::get('/candidate_view', [UserController::class, 'candidate_home']);
