...
<div class="container mt-5">
  <div class="row">
    <div class="col-sm-4">
      ...
      <h5>Photo of me:</h5> -->
      <div class="fakeimg">
      <img src="/image/Jonathan-Headshot.jpg" alt="profile pic"  class="rounded-circle"  width="150" height="90" class="devAvatar" />
      </div>
    </div>
    <div class="col-sm-4">
      <h2>Olanrewaju Kabir</h2>
      <h5>Fullstack Developer</h5>
      <h5> php css laravel</h5>
      <h5>larrtopmost@gmail.com</h5>
  ...
  <button type="button" class="btn btn-primary">Hide</button>
    ...
    <div class="col-sm-12">
      <h2> Intro</h2>
      <p>Sunt in culpa qui officia deserunt mollit anim id est laborum consectetur adipisciuiohdfjkhdgsjsjhfdsjkhfsdjkhhdhkjhgfjkbnfdjhdkjsfsdkjhsdfjkfkjhsdkjffdsjjhdsfkjjhfdkjsng elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
